Locales ['en'] = {
  -- weed
  ['weed_pickupprompt'] = 'press ~INPUT_CONTEXT~ to drill the ~y~Stone~s~.',
  ['stone_inventoryfull'] = 'you do not have any more inventory space for ~y~Stone~s~.',
  ['weed_processprompt'] = 'press ~INPUT_CONTEXT~ to start ~g~Process Stone~s~.',
  ['weed_processingstarted'] = 'processing ~g~Stone~s~ into ~g~Marijuana~s~...',
  ['weed_processingfull'] = 'processing ~r~canceled~s~ due to full inventory!',
  ['weed_processingenough'] = 'you must have ~b~3x~s~ ~g~Stone~s~ in order to process.',
  ['weed_processed'] = 'you\'ve processed ~b~3x~s~ ~g~Stone~s~ to ~b~1x~s~ ~g~Marijuana~s~',
