Locales ['en'] = {
  -- weed
  ['weed_pickupprompt'] = 'press ~INPUT_CONTEXT~ to harvest the ~g~Gold~s~.',
  ['weed_inventoryfull'] = 'you do not have any more inventory space for ~g~Gold~s~.',
  ['weed_processprompt'] = 'press ~INPUT_CONTEXT~ to start ~g~Process Dirty Gold~s~.',
  ['weed_processingstarted'] = 'processing ~g~Dirty Gold~s~ into ~g~Gold ~s~...',
  ['weed_processingfull'] = 'processing ~r~canceled~s~ due to full inventory!',
  ['weed_processingenough'] = 'you must have ~b~~s~ ~g~Dirty Gold~s~ in order to process.',
  ['weed_processed'] = 'you\'ve processed ~b~~s~ ~g~Dirty Cannabis~s~ to ~b~~s~ ~g~Gold ~s~',
  ...
  -- blips
  ['blip_weedfield'] = 'Gold Field',
  ['blip_weedprocessing'] = 'Gold Processing',
