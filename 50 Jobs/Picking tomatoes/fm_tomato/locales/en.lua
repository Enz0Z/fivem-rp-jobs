Locales ['en'] = {
  -- weed
  ['weed_pickupprompt'] = 'press ~INPUT_CONTEXT~ to harvest the ~g~tomato~s~.',
  ['weed_inventoryfull'] = 'you do not have any more inventory space for ~g~tomato~s~.',
  ['weed_processprompt'] = 'press ~INPUT_CONTEXT~ to start ~g~Process tomato~s~.',
  ['weed_processingstarted'] = 'processing ~g~tomato~s~ into ~g~Transparent Glass ~s~...',
  ['weed_processingfull'] = 'processing ~r~canceled~s~ due to full inventory!',
  ['weed_processingenough'] = 'you must have ~b~3x~s~ ~g~tomato~s~ in order to process.',
  ...
  -- blips
  ['blip_weedfield'] = 'tomato Field',
  ['blip_weedprocessing'] = 'tomato Processing',
