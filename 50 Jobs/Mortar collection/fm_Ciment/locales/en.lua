Locales ['en'] = {
  -- weed
  ['weed_pickupprompt'] = 'press ~INPUT_CONTEXT~ to harvest the ~g~Ciment~s~.',
  ['weed_inventoryfull'] = 'you do not have any more inventory space for ~g~Ciment~s~.',
  ['weed_processprompt'] = 'press ~INPUT_CONTEXT~ to start ~g~Process Ciment~s~.',
  ['weed_processingstarted'] = 'processing ~g~Ciment~s~ into ~g~Transparent Glass ~s~...',
  ['weed_processingfull'] = 'processing ~r~canceled~s~ due to full inventory!',
  ['weed_processingenough'] = 'you must have ~b~3x~s~ ~g~Ciment~s~ in order to process.',
  ...
  -- blips
  ['blip_weedfield'] = 'Ciment Field',
  ['blip_weedprocessing'] = 'Ciment Processing',
