Locales ['en'] = {
  -- weed
  ['weed_pickupprompt'] = 'press ~INPUT_CONTEXT~ to harvest the ~g~Salt~s~.',
  ['weed_inventoryfull'] = 'you do not have any more inventory space for ~g~Salt~s~.',
  ['weed_processprompt'] = 'press ~INPUT_CONTEXT~ to start ~g~Process Salt~s~.',
  ['weed_processingstarted'] = 'processing ~g~Salt~s~ into ~g~Transparent Glass ~s~...',
  ['weed_processingfull'] = 'processing ~r~canceled~s~ due to full inventory!',
  ['weed_processingenough'] = 'you must have ~b~3x~s~ ~g~Salt~s~ in order to process.',
  ...
  -- blips
  ['blip_weedfield'] = 'Salt Field',
  ['blip_weedprocessing'] = 'Salt Processing',
