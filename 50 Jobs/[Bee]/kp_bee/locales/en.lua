Locales ['en'] = {
  -- weed
  ['weed_pickupprompt'] = 'press ~INPUT_CONTEXT~ to harvest the ~g~Honey~s~.',
  ['weed_inventoryfull'] = 'you do not have any more inventory space for ~g~Honey~s~.',
  ['weed_processprompt'] = 'press ~INPUT_CONTEXT~ to start ~g~Process Honey~s~.',
  ['weed_processingstarted'] = 'processing ~g~Honey~s~ into ~g~Transparent Glass ~s~...',
  ['weed_processingfull'] = 'processing ~r~canceled~s~ due to full inventory!',
  ['weed_processingenough'] = 'you must have ~b~3x~s~ ~g~Honey~s~ in order to process.',
  ...
  -- blips
  ['blip_weedfield'] = 'Honey Field',
  ['blip_weedprocessing'] = 'Honey Processing',
