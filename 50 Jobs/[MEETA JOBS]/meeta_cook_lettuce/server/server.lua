...
RegisterServerEvent('meeta_cook_lettuce:pickedUp')
AddEventHandler('meeta_cook_lettuce:pickedUp', function()
...
ESX.RegisterServerCallback('meeta_cook_lettuce:checkItem', function(source, cb, item, item2)
	local xPlayer = ESX.GetPlayerFromId(source)
...
ESX.RegisterServerCallback('meeta_cook_lettuce:canPickUp', function(source, cb, item)
	local xPlayer = ESX.GetPlayerFromId(source)
	local xItem = xPlayer.getInventoryItem(item)
