...
RegisterServerEvent('meeta_cook_tomato:pickedUp')
AddEventHandler('meeta_cook_tomato:pickedUp', function()
...
ESX.RegisterServerCallback('meeta_cook_tomato:checkItem', function(source, cb, item, item2)
	local xPlayer = ESX.GetPlayerFromId(source)
...
ESX.RegisterServerCallback('meeta_cook_tomato:canPickUp', function(source, cb, item)
	local xPlayer = ESX.GetPlayerFromId(source)
	local xItem = xPlayer.getInventoryItem(item)
