...
RegisterServerEvent('meeta_cook_corn:pickedUp')
AddEventHandler('meeta_cook_corn:pickedUp', function()
...
ESX.RegisterServerCallback('meeta_cook_corn:checkItem', function(source, cb, item, item2)
	local xPlayer = ESX.GetPlayerFromId(source)
...
ESX.RegisterServerCallback('meeta_cook_corn:canPickUp', function(source, cb, item)
	local xPlayer = ESX.GetPlayerFromId(source)
	local xItem = xPlayer.getInventoryItem(item)
