Locales ['en'] = {
  -- weed
  ['weed_pickupprompt'] = 'press ~INPUT_CONTEXT~ to harvest the ~g~grape~s~.',
  ['weed_inventoryfull'] = 'you do not have any more inventory space for ~g~grape~s~.',
  ['weed_processprompt'] = 'press ~INPUT_CONTEXT~ to start ~g~Process grape~s~.',
  ['weed_processingstarted'] = 'processing ~g~grape~s~ into ~g~Transparent Glass ~s~...',
  ['weed_processingfull'] = 'processing ~r~canceled~s~ due to full inventory!',
  ['weed_processingenough'] = 'you must have ~b~3x~s~ ~g~grape~s~ in order to process.',
  ...
  -- blips
  ['blip_weedfield'] = 'grape Field',
  ['blip_weedprocessing'] = 'grape Processing',
