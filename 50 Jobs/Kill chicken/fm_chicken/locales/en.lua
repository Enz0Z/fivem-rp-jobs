Locales ['en'] = {
  -- weed
  ['weed_pickupprompt'] = 'press ~INPUT_CONTEXT~ to harvest the ~g~chicken~s~.',
  ['weed_inventoryfull'] = 'you do not have any more inventory space for ~g~chicken~s~.',
  ['weed_processprompt'] = 'press ~INPUT_CONTEXT~ to start ~g~Process chicken~s~.',
  ['weed_processingstarted'] = 'processing ~g~chicken~s~ into ~g~Transparent Glass ~s~...',
  ...
  -- blips
  ['blip_weedfield'] = 'chicken Field',
  ['blip_weedprocessing'] = 'chicken Processing',
