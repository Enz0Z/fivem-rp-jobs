Locales ['en'] = {
  -- weed
  ['weed_pickupprompt'] = 'press ~INPUT_CONTEXT~ to harvest the ~g~bucket~s~.',
  ['weed_inventoryfull'] = 'you do not have any more inventory space for ~g~bucket~s~.',
  ['weed_processprompt'] = 'press ~INPUT_CONTEXT~ to start ~g~Process bucket~s~.',
  ['weed_processingstarted'] = 'processing ~g~bucket~s~ into ~g~Transparent Glass ~s~...',
  ['weed_processingfull'] = 'processing ~r~canceled~s~ due to full inventory!',
  ['weed_processingenough'] = 'you must have ~b~3x~s~ ~g~bucket~s~ in order to process.',
  ...
  -- blips
  ['blip_weedfield'] = 'bucket Field',
  ['blip_weedprocessing'] = 'bucket Processing',
