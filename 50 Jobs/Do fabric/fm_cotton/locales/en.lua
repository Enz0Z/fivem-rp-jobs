Locales ['en'] = {
  -- weed
  ['weed_pickupprompt'] = 'press ~INPUT_CONTEXT~ to harvest the ~g~cotton~s~.',
  ['weed_inventoryfull'] = 'you do not have any more inventory space for ~g~cotton~s~.',
  ['weed_processprompt'] = 'press ~INPUT_CONTEXT~ to start ~g~Process cotton~s~.',
  ['weed_processingstarted'] = 'processing ~g~cotton~s~ into ~g~Transparent Glass ~s~...',
  ['weed_processingfull'] = 'processing ~r~canceled~s~ due to full inventory!',
  ['weed_processingenough'] = 'you must have ~b~3x~s~ ~g~cotton~s~ in order to process.',
  ...
  -- blips
  ['blip_weedfield'] = 'cotton Field',
  ['blip_weedprocessing'] = 'cotton Processing',
