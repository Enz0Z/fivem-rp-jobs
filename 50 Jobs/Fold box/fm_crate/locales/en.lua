Locales ['en'] = {
  -- weed
  ['weed_pickupprompt'] = 'press ~INPUT_CONTEXT~ to harvest the ~g~crate~s~.',
  ['weed_inventoryfull'] = 'you do not have any more inventory space for ~g~crate~s~.',
  ['weed_processprompt'] = 'press ~INPUT_CONTEXT~ to start ~g~Process crate~s~.',
  ['weed_processingstarted'] = 'processing ~g~crate~s~ into ~g~Transparent Glass ~s~...',
  ['weed_processingfull'] = 'processing ~r~canceled~s~ due to full inventory!',
  ['weed_processingenough'] = 'you must have ~b~3x~s~ ~g~crate~s~ in order to process.',
  ...
  -- blips
  ['blip_weedfield'] = 'crate Field',
  ['blip_weedprocessing'] = 'crate Processing',
