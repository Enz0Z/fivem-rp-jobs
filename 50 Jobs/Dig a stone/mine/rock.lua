...
function Process()
	...
	exports['progressBars']:startUI(10000, "กำลังคัดหิน") --ให้ค่าเวลาเท่ากับที่โชอะนิเมชั่น	
	...
	while true do
		...
		if nearbyObject and IsPedOnFoot(playerPed) then
					...
					if not isPickingUp then
						ESX.ShowHelpNotification("Press ~INPUT_CONTEXT~ to ~g~Drill")
					end
					...
					if IsControlJustReleased(0, 38) and not isPickingUp then
						...
						ESX.TriggerServerCallback('caruby_mining:canPickUp', function(canPickUp)
								...
								if canPickUp then
									...
									exports['progressBars']:startUI(5000, "กำลังเจาะหิน") --ให้ค่าเวลาเท่ากับที่โชอะนิเมชั่น	
									Citizen.Wait(5000)
