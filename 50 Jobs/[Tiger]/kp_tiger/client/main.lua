...
local Positions = {
	['StartHunting'] = { ['hint'] = '[E] Start Hunting', ['x'] = -651.21, ['y'] = 1417.11, ['z'] = 304.35 },
	--['Sell'] = { ['hint'] = '[E] Sell', ['x'] = 6.9, ['y'] = -1816.6, ['z'] = 25.4 },
	...
	if OnGoingHuntSession then
		...
		Citizen.CreateThread(function()
			...
			for index, value in pairs(AnimalPositions) do
				...
				BeginTextCommandSetBlipName("STRING")
				AddTextComponentString('Tiger - Animal')
...
BeginTextCommandSetBlipName("STRING")
AddTextComponentString("Tiger hunting")
...
SetBlipAsShortRange(blip, true)
BeginTextCommandSetBlipName("STRING")
AddTextComponentString("Selling Tiger Meat")
EndTextCommandSetBlipName(blip)]]
