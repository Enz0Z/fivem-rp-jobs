Locales ['en'] = {
  -- weed
  ['weed_pickupprompt'] = 'press ~INPUT_CONTEXT~ to harvest the ~g~shell~s~.',
  ['weed_inventoryfull'] = 'you do not have any more inventory space for ~g~shell~s~.',
  ['weed_processprompt'] = 'press ~INPUT_CONTEXT~ to start ~g~Process shell~s~.',
  ['weed_processingstarted'] = 'processing ~g~shell~s~ into ~g~Transparent Glass ~s~...',
  ['weed_processingfull'] = 'processing ~r~canceled~s~ due to full inventory!',
  ['weed_processingenough'] = 'you must have ~b~3x~s~ ~g~shell~s~ in order to process.',
  ...
  -- blips
  ['blip_weedfield'] = 'shell Field',
  ['blip_weedprocessing'] = 'shell Processing',
