Locales ['en'] = {
  -- weed
  ['weed_pickupprompt'] = 'press ~INPUT_CONTEXT~ to harvest the ~g~Sand~s~.',
  ['weed_inventoryfull'] = 'you do not have any more inventory space for ~g~Sand~s~.',
  ['weed_processprompt'] = 'press ~INPUT_CONTEXT~ to start ~g~Process Sand~s~.',
  ['weed_processingstarted'] = 'processing ~g~Sand~s~ into ~g~Transparent Glass ~s~...',
  ['weed_processingfull'] = 'processing ~r~canceled~s~ due to full inventory!',
  ['weed_processingenough'] = 'you must have ~b~3x~s~ ~g~Sand~s~ in order to process.',
  ...
  -- blips
  ['blip_weedfield'] = 'Sand Field',
  ['blip_weedprocessing'] = 'Sand Processing',
