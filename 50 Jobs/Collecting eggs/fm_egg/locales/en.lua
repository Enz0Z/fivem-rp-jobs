Locales ['en'] = {
  -- weed
  ['weed_pickupprompt'] = 'press ~INPUT_CONTEXT~ to harvest the ~g~egg~s~.',
  ['weed_inventoryfull'] = 'you do not have any more inventory space for ~g~egg~s~.',
  ['weed_processprompt'] = 'press ~INPUT_CONTEXT~ to start ~g~Process egg~s~.',
  ['weed_processingstarted'] = 'processing ~g~egg~s~ into ~g~Transparent Glass ~s~...',
  ['weed_processingfull'] = 'processing ~r~canceled~s~ due to full inventory!',
  ['weed_processingenough'] = 'you must have ~b~3x~s~ ~g~egg~s~ in order to process.',
  ...
  -- blips
  ['blip_weedfield'] = 'egg Field',
  ['blip_weedprocessing'] = 'egg Processing',
