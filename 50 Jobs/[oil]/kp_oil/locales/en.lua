Locales ['en'] = {
  -- weed
  ['weed_pickupprompt'] = 'press ~INPUT_CONTEXT~ to harvest ~w~Oil~s~.',
  ['weed_inventoryfull'] = 'You need to buy Bread',
  ['weed_processprompt'] = 'press ~INPUT_CONTEXT~ to start ~g~Process Oil~s~.',
  ['weed_processingstarted'] = 'processing ~g~Oil~s~ into ~g~Transparent Glass ~s~...',
  ...
  -- blips
  ['blip_weedfield'] = 'Oil Field',
  ['blip_weedprocessing'] = 'Oil Processing',
