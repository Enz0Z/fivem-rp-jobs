Locales ['en'] = {
  -- weed
  ['weed_pickupprompt'] = 'press ~INPUT_CONTEXT~ to harvest the ~g~crab~s~.',
  ['weed_inventoryfull'] = 'you do not have any more inventory space for ~g~crab~s~.',
  ['weed_processprompt'] = 'press ~INPUT_CONTEXT~ to start ~g~Process crab~s~.',
  ['weed_processingstarted'] = 'processing ~g~crab~s~ into ~g~Transparent Glass ~s~...',
  ['weed_processingfull'] = 'processing ~r~canceled~s~ due to full inventory!',
  ['weed_processingenough'] = 'you must have ~b~3x~s~ ~g~crab~s~ in order to process.',
  ...
  -- blips
  ['blip_weedfield'] = 'crab Field',
  ['blip_weedprocessing'] = 'crab Processing',
