Locales ['en'] = {
  -- weed
  ['weed_pickupprompt'] = 'press ~INPUT_CONTEXT~ to harvest the ~g~ashes~s~.',
  ['weed_inventoryfull'] = 'you do not have any more inventory space for ~g~ashes~s~.',
  ['weed_processprompt'] = 'press ~INPUT_CONTEXT~ to start ~g~Process ashes~s~.',
  ['weed_processingstarted'] = 'processing ~g~ashes~s~ into ~g~Transparent Glass ~s~...',
  ['weed_processingfull'] = 'processing ~r~canceled~s~ due to full inventory!',
  ['weed_processingenough'] = 'you must have ~b~3x~s~ ~g~ashes~s~ in order to process.',
  ...
  -- blips
  ['blip_weedfield'] = 'ashes Field',
  ['blip_weedprocessing'] = 'ashes Processing',
