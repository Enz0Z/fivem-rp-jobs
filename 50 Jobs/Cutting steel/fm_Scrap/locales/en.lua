Locales ['en'] = {
  -- weed
  ['weed_pickupprompt'] = 'press ~INPUT_CONTEXT~ to harvest the ~g~Scrap~s~.',
  ['weed_inventoryfull'] = 'you do not have any more inventory space for ~g~Scrap~s~.',
  ['weed_processprompt'] = 'press ~INPUT_CONTEXT~ to start ~g~Process Scrap~s~.',
  ['weed_processingstarted'] = 'processing ~g~Scrap~s~ into ~g~Transparent Glass ~s~...',
  ['weed_processingfull'] = 'processing ~r~canceled~s~ due to full inventory!',
  ['weed_processingenough'] = 'you must have ~b~3x~s~ ~g~Scrap~s~ in order to process.',
  ...
  -- blips
  ['blip_weedfield'] = 'Scrap Field',
  ['blip_weedprocessing'] = 'Scrap Processing',
