Locales ['en'] = {
  -- weed
  ['weed_pickupprompt'] = 'press ~INPUT_CONTEXT~ to harvest the ~g~poteto~s~.',
  ['weed_inventoryfull'] = 'you do not have any more inventory space for ~g~poteto~s~.',
  ['weed_processprompt'] = 'press ~INPUT_CONTEXT~ to start ~g~Process poteto~s~.',
  ['weed_processingstarted'] = 'processing ~g~poteto~s~ into ~g~Transparent Glass ~s~...',
  ['weed_processingfull'] = 'processing ~r~canceled~s~ due to full inventory!',
  ['weed_processingenough'] = 'you must have ~b~3x~s~ ~g~poteto~s~ in order to process.',
  ...
  -- blips
  ['blip_weedfield'] = 'poteto Field',
  ['blip_weedprocessing'] = 'poteto Processing',
