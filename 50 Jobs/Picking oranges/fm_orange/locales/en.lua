Locales ['en'] = {
  -- weed
  ['weed_pickupprompt'] = 'press ~INPUT_CONTEXT~ to harvest the ~g~First1~s~.',
  ['weed_inventoryfull'] = 'you do not have any more inventory space for ~g~First1~s~.',
  ['weed_processprompt'] = 'press ~INPUT_CONTEXT~ to start ~g~Process First1~s~.',
  ['weed_processingstarted'] = 'processing ~g~First1~s~ into ~g~Transparent Glass ~s~...',
  ['weed_processingfull'] = 'processing ~r~canceled~s~ due to full inventory!',
  ['weed_processingenough'] = 'you must have ~b~3x~s~ ~g~First1~s~ in order to process.',
