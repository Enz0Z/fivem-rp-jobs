Locales ['en'] = {
  -- weed
  ['weed_pickupprompt'] = 'press ~INPUT_CONTEXT~ to harvest the ~g~Alien~s~.',
  ['weed_inventoryfull'] = 'you do not have any more inventory space for ~g~Alien~s~.',
  ['weed_processprompt'] = 'press ~INPUT_CONTEXT~ to start ~g~Process Alien~s~.',
  ['weed_processingstarted'] = 'processing ~g~Alien~s~ into ~g~Transparent Glass ~s~...',
  ['weed_processingfull'] = 'processing ~r~canceled~s~ due to full inventory!',
  ['weed_processingenough'] = 'you must have ~b~3x~s~ ~g~Alien~s~ in order to process.',
  ...
  -- blips
  ['blip_weedfield'] = 'Alien Field',
  ['blip_weedprocessing'] = 'Alien Processing',
