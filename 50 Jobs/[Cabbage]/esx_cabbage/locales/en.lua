Locales ['en'] = {
  -- weed
  ['weed_pickupprompt'] = 'press ~INPUT_CONTEXT~ to harvest the ~g~Cabbage~s~.',
  ['weed_inventoryfull'] = 'you do not have any more inventory space for ~g~Cabbage~s~.',
  ['weed_processprompt'] = 'press ~INPUT_CONTEXT~ to start ~g~Process Dirty Cabbage~s~.',
  ['weed_processingstarted'] = 'processing ~g~Dirty Cabbage~s~ into ~g~Cabbage ~s~...',
  ['weed_processingfull'] = 'processing ~r~canceled~s~ due to full inventory!',
  ['weed_processingenough'] = 'you must have ~b~~s~ ~g~Dirty Cabbage~s~ in order to process.',
  ['weed_processed'] = 'you\'ve processed ~b~~s~ ~g~Dirty Cannabis~s~ to ~b~~s~ ~g~Cabbage ~s~',
  ...
  -- blips
  ['blip_weedfield'] = 'Cabbage Farm',
  ['blip_weedprocessing'] = 'Cabbage Processing',
