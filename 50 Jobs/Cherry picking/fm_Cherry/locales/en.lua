Locales ['en'] = {
  -- weed
  ['weed_pickupprompt'] = 'press ~INPUT_CONTEXT~ to harvest the ~g~Cherry~s~.',
  ['weed_inventoryfull'] = 'you do not have any more inventory space for ~g~Cherry~s~.',
  ['weed_processprompt'] = 'press ~INPUT_CONTEXT~ to start ~g~Process Cherry~s~.',
  ['weed_processingstarted'] = 'processing ~g~Cherry~s~ into ~g~Transparent Glass ~s~...',
  ['weed_processingfull'] = 'processing ~r~canceled~s~ due to full inventory!',
  ['weed_processingenough'] = 'you must have ~b~3x~s~ ~g~Cherry~s~ in order to process.',
  ...
  -- blips
  ['blip_weedfield'] = 'Cherry Field',
  ['blip_weedprocessing'] = 'Cherry Processing',
